...
- 3 [🗄️ Sistema Gerenciador de Banco de Dados (SGBD)](#3-sistema-gerenciador-de-banco-de-dados-sgbd)
- 4 [🗃️ Banco de Dados Relacional](#4-banco-de-dados-relacional)
- 5 [⚙️ Instalação do MySQL](#5-instalação-do-mysql)
- 6 [🏗️ Estrutura de um Banco de Dados](#6-estrutura-de-um-banco-de-dados)
- 7 [🔤 Tipos de Dados](#7-tipos-de-dados)
- 8 [🛠️ Comandos DDL](#8-comandos-ddl)
- 9 [✍️ Comandos DML](#9-comandos-dml)
- 10 [🔎 Comandos DQL](#10-comandos-dql)
- 11 [🔑 Constraints](#11-constraints)
- 12 [📊 Funções de Agregação](#12-funções-de-agregação)
- 13 [➕ Operadores SQL](#13-operadores-sql)
- 14 [🔗 JOINs](#14-joins)
- 15 [👁️ Views](#15-views)
- 16 [⚡ Procedures](#16-procedures)
- 17 [🚦 Triggers](#17-triggers)
- 18 [📇 Índices](#18-índices)
- 19 [💾 Backup](#19-backup)
